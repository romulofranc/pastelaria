...
function addEncomenda(novaEncomenda){
    ...
    var tabela = document.querySelector("#tabelaInteira");
...
function montaTR(novaEncomenda){
    ...
    tr.appendChild(montaTD(formata(parseFloat(novaEncomenda.unitario))));
    tr.appendChild(montaTD(formata(calculaTotal(novaEncomenda.qtde, novaEncomenda.unitario))));
